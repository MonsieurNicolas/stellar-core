...
class TransactionFrame
{
  protected:
    ...
    ValidationType
    commonValid(SignatureChecker& signatureChecker, Application& app,
                AbstractLedgerState& lsOuter, SequenceNumber current,
                bool applying);
  ...
  public:
    ...
    bool apply(Application& app, AbstractLedgerState& ls, TransactionMetaV1& meta);
