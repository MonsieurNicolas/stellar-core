...
TEST_CASE("History prefix catchup", "[history][historycatchup][prefixcatchup]")
{
    ...
    apps.push_back(a);
    CHECK(apps.back()->getLedgerManager().getLastClosedLedgerNum() == 2 * freq + 1);
}
          ...
          "[history][historycatchup][catchupalternation]")
{
    ...
    CHECK(app2->getLedgerManager().getLastClosedLedgerNum() == lm.getLastClosedLedgerNum());
    CHECK(app3->getLedgerManager().getLastClosedLedgerNum() == lm.getLastClosedLedgerNum());
