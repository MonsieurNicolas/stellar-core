...
LedgerStateRoot::Impl::getFromBestOffersCache(
    BestOffersCacheKey const& cacheKey) const
{
    try
    {
...
void
LedgerStateRoot::Impl::putInBestOffersCache(
    BestOffersCacheKey const& cacheKey, BestOffersCacheEntry const& entry) const
{
    try
    {
